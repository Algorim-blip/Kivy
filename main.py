...
Window.clearcolor = (0.10, 0.30, 0.5, 0.3)# фон экрана
btn_color = (0.97, 0.9, 0.8, 1)#фон кнопки
...
class CheckSits(Screen):
    ...
    def next(self):
        if not self.next_screen:
            ...
            gif_im = Image(source='Squats.gif', anim_delay=0.15)
            gif_im.pos = (10,265)
            self.add_widget(gif_im)
            self.btn_text = "Закончить"
        else:
